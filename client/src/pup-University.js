...
export default function PUPUniversity(){
    return(<>
    <div className="mb-5 min-h-screen  font-mons ">
        ...
        <div className="flex justify-center w-full">
            <div className="w-[70%]">
                <img src="/pup.png" className="mx-auto"/>
                <div className="font-bold text-lg text-center">Punjabi University,Patiala(PUP)</div>
                <div className="mt-2 mb-5">Our website provides notes for BCA, BBA. Doing preparation from the notes helps you to get good marks in exams. From our PU-PATIALA notes bank, students can download notes. These notes are very easy to understand</div>
                <Link to='/Punjabi University,Patiala (PUP)/BCA' className=" text-[#3d90e3] w-full py-2 mt-2">
