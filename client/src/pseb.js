    ...
    <div className="mb-5 min-h-screen  font-mons ">
        ...
        <div className="flex justify-center w-full">
            <div className="w-[70%]">
                ...
                <Link to='/PSEB/classes?class=10th' state={'PSEB'} className=" text-[#3d90e3] w-full py-2 mt-2">
                    <div className="text-xl font-semibold bg-teal-900 w-full pl-3 mb-5 py-3">10th</div>
                </Link>
                <Link to='/PSEB/classes?class=12th' state={'PSEB'} className=" text-[#3d90e3] w-full py-2 mt-2">
