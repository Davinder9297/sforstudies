...
export default function Cbse(){
    ...
    <div className="mb-5 min-h-screen  font-mons ">
        ...
        <div className="flex justify-center w-full">
            <div className="w-[70%]">
                <img src="/cbse.jpg" className="mx-auto"/>
                <div className="font-bold text-lg text-center">Central Board Of Secondary Education (CBSE)</div>
                <div className="mt-2 mb-5">Our website provides solved notes for 10th, 12th. Doing preparation from the notes helps you to get good marks in exams. From our CBSE(School) bank, students can download notes. These notes are very easy to understand.</div>
                <Link to='/CBSE/classes?class=10th' state={'CBSE'} className=" text-[#3d90e3] w-full py-2 mt-2">
                    <div className="text-xl font-semibold bg-teal-900 w-full pl-3 mb-5 py-3">10th</div>
                </Link>
                <Link to='/CBSE/classes?class=12th' state={'CBSE'} className=" text-[#3d90e3] w-full py-2 mt-2">
